...
Aquity analysis of educational attainment by race for Santa Clara county, CA. Using 2019 ACS 5-yr summary data.
```{r}
library(tidyverse)
library(censusapi)
...
#educational attainment for not white not latinx
